...
const Card = (props) => {
    ...
    return (
        <div className="w-80 overflow-hidden rounded-lg shadow-xl shadow-slate-950">
            {children}
    </div>
    )
}
...
const Body = ( props ) => {
    ...
    return (
        <div className="px-4 pb-1 bg-slate-950 overflow-hidden">
        <a href="">
            <h5 className="text-white font-bold text-md  text-center mt-3">{title}</h5>
        </a>
